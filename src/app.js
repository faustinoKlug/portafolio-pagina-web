...
const botonEstudios = document.querySelector('#estudios')
const botonSkills = document.querySelector('#skills')

const perfil = document.querySelector('#perfil-div')
const estudios = document.querySelector('#estudios-div')
